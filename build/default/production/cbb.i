...
# 1 "D:/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__size_t.h" 1 3
...
# 1 "D:/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\__null.h" 1 3
...
unsigned char view_log(unsigned char key,unsigned char reset_flag, unsigned char control_flag)
{
    ...
    else
    {
        ...
        new = (overflow)? (pos + 1) % 10 : 0;
            ...
            else if(key == 0x3D && control_flag == 0x04)
            {
                if(num > 0)
                {
                num = num-1;
    ...
    new = (new+num)%10;
            if(key == 0x22 && control_flag == 0x04)
            {
                control_flag = 0x03;
            }


            clcd_print("LOGS",(0x80 + 4));
            clcd_putch(num + '0', (0xC0 + 0));
            clcd_putch(view_log_arr[0], (0xC0 + 3));
            clcd_putch(view_log_arr[1], (0xC0 + 4));
            clcd_putch(view_log_arr[2], (0xC0 + 5));
            clcd_putch(view_log_arr[3], (0xC0 + 6));
            clcd_putch(view_log_arr[4], (0xC0 + 7));
            clcd_putch(view_log_arr[5], (0xC0 + 8));
            clcd_putch(view_log_arr[6], (0xC0 + 9));
            clcd_putch(view_log_arr[7], (0xC0 + 10));
            clcd_putch(view_log_arr[8], (0xC0 + 11));
            clcd_putch(view_log_arr[9], (0xC0 + 12));
...
unsigned char change_pwd(unsigned char key, unsigned char reset_flag,unsigned char control_flag)
{
    ...
    if(reset_flag == 0x70 && i < 4 && flag == 0)
    {
    clcd_print(" ENTER NEW PWD",(0x80 + 1));
     clcd_write(0xC6,0);
    clcd_write(0x0F,0);
    _delay((unsigned long)((100)*(20000000/4000000.0)));
    }
            if(key == 0x3E && i < 4 && flag == 0)
            {
                if(i == 3)
                {
                    key = 0x3F;
    ...
    if(key == 0x3F && reset_flag == 0x80 && i== 4 && s < 4 && flag == 1)
    {

    clcd_print("REENTER NEWPWD",(0x80 + 1));
     clcd_write(0xC6,0);
    clcd_write(0x0F,0);
    _delay((unsigned long)((100)*(20000000/4000000.0)));
    }
            if(key == 0x3E && i == 4 && s < 4 && flag == 1)
            {
                pwd1[s] = '4';
                clcd_putch('*',(0xC0 + 6+s));
                s++;
            ...
            else if(key == 0x3D && i == 4 && s < 4 && flag == 1)
            {
                pwd1[s] = '5';
                clcd_putch('*',(0xC0 + 6+s));
                s++;
...
unsigned char set_time(unsigned char key,unsigned char control_flag)
{
    ...
    else if(key == 0x3D && flag == 1 && position < 3)
    {
        position++;

    }
    else if(key == 0x2F && flag == 1 && position < 3)
    {
        set_time_arr[position]--;
    }
    else if(key == 0x3B && flag == 1)
    {
    ...
    clcd_putch(set_time_arr[0] / 10 + '0',(0xC0 + 4));
    clcd_putch(set_time_arr[0] % 10 + '0',(0xC0 + 5));
    clcd_putch(':',(0xC0 + 6));
    clcd_putch(set_time_arr[1] / 10 + '0',(0xC0 + 7));
    clcd_putch(set_time_arr[1] % 10 + '0',(0xC0 + 8));
    clcd_putch(':',(0xC0 + 9));
    clcd_putch(set_time_arr[2] / 10 + '0',(0xC0 + 10));
    clcd_putch(set_time_arr[2] % 10 + '0',(0xC0 + 11));
