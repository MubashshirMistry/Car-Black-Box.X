...
void main(void) {
    ...
    while (1) {
        ...
        else if( key == 0x3D && gr < 6 && control_flag == 0x01)
        {
        ...
        else if(key == 0x3B && gr > 0 && control_flag == 0x01)
        {
            gr--;
            strcpy(event,gear[gr]);
             log_car_event(event,speed);
...
# 145 "main.c"
        ...
        else if(key == 0x22 && control_flag == 0x04)
        {
        ...
        else if(key == 0x22 && control_flag == 0x05)
        {
            clear_screen();
            control_flag = 0x03;

        }
        else if(key == 0x22 && control_flag == 0x06)
        {
            clear_screen();
            control_flag = 0x03;

        }
        else if(key == 0x22 && control_flag == 0x08)
        {
            clear_screen();
            control_flag = 0x03;

        }
        else if(key == 0x22 && control_flag == 0x07)
        {
            clear_screen();
            control_flag = 0x03;
             clcd_write(0x0C,0);
        ...
        else if(key == 0x22 && control_flag == 0x03)
        {
            clear_screen();
            control_flag = 0x01;
            reset_flag = 0x10;
        ...
        switch(control_flag)
        {
            ...
            case 0x04:
                 ...
                 {
                     clear_screen;
                      clcd_print("NO LOGS AVAILABLE", (0x80 + 0));
...
clear_screen();
            ...
            case 0x07:
                 ...
                 else if(chng_pwd == 0x0A)
                 {
                     clear_screen();
                      TMR2ON = 0;
                        clcd_write(0x0C,0);
                     clcd_print("PWD NOT CHANGED",(0x80 + 2));
                     clcd_print("TRY AGAIN",(0xC0 + 3));
                     _delay((unsigned long)((3000)*(20000000/4000.0)));
                     clear_screen();
                     control_flag = 0x03;
                     reset_flag = 0x70;
            ...
            case 0x05:
               ...
               if(clear_lg == 0xA0)
               {
                    clcd_print("LOGS CLEARED",(0x80 + 3));
